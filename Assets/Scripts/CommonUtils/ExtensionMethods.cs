...
public static class ExtensionMethods
{
	...
	public static Texture2D ToGrayscale(this Texture2D i_text)
	{
		Texture2D text = new Texture2D (i_text.width, i_text.height);
		UnityEngine.Color[] pixels = i_text.GetPixels ();
